...
public class PeripheralEssentiaTransport implements IPeripheral {
    ...
    public String[] getMethodNames() {
        return new String[] { "isConnectable", "canInputFrom", "canOutputTo", "getSuctionType", "getSuctionAmount",
                "getEssentiaType", "getEssentiaAmount", "getMinimumSuction" };
    }
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        switch (method) {
            ...
            case 3:
                return new Object[] {
                        pipe.getSuctionType(ForgeDirection.getOrientation(GetDirection(arguments[0]))).getTag() };
            case 4:
                return new Object[] {
                        pipe.getSuctionAmount(ForgeDirection.getOrientation(GetDirection(arguments[0]))) };
            case 5:
                return new Object[] {
                        pipe.getEssentiaType(ForgeDirection.getOrientation(GetDirection(arguments[0]))).getTag() };
            case 6:
                return new Object[] {
                        pipe.getEssentiaAmount(ForgeDirection.getOrientation(GetDirection(arguments[0]))) };
            case 7:
