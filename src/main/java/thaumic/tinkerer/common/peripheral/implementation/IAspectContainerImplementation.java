...
public class IAspectContainerImplementation {
    public static Object[] getAspects(IAspectContainer container) {
        ...
        if (container.getAspects() == null || container.getAspects().size() == 0) return new Object[] {returnStuff};

        for (Aspect aspect : container.getAspects().getAspectsSorted()) returnStuff.put(i++, aspect.getTag());
    ...
    public static Object[] getAspectCount(IAspectContainer container, String aspectName) {
        ...
        if (container.getAspects() == null) return new Object[] {0};
