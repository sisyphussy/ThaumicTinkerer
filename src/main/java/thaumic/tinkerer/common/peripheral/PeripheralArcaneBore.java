...
public class PeripheralArcaneBore implements IPeripheral {
    ...
    public String[] getMethodNames() {
        return new String[] { "hasPickaxe", "hasFocus", "isPickaxeBroken", "isWorking", "getRadius", "getSpeed",
                "hasNativeClusters", "getFortune", "hasSilkTouch" };
    }
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments) {
        ...
        switch (method) {
            ...
            case 3: // noinspection ConstantConditions
                return new Object[] { bore.gettingPower() && bore.hasFocus
                        && bore.hasPickaxe
                        && pickaxe.isItemStackDamageable()
                        && !nearBroken };
            case 4:
            ...
            case 8:
                return new Object[] {
                        EnchantmentHelper.getEnchantmentLevel(Enchantment.silkTouch.effectId, pickaxe) > 0 };
        }
