...
public final class ResearchHelper {
    ...
    public static void initResearch() {
        ...
        research = new TTResearchItem(
                ...
                2,
                2,
                new ResourceLocation(LibResources.ENCHANT_ASCENT_BOOST)).setParents(LibResearch.KEY_ENCHANTER);
        ...
        research = new TTResearchItem(
                ...
                3,
                2,
                new ResourceLocation(LibResources.ENCHANT_SLOW_FALL)).setParents(LibResearch.KEY_ENCHANTER);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        research = new TTResearchItem(
                ...
                5,
                2,
                new ResourceLocation(LibResources.ENCHANT_AUTO_SMELT)).setParents(LibResearch.KEY_ENCHANTER);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        research = new TTResearchItem(
                ...
                6,
                2,
                new ResourceLocation(LibResources.ENCHANT_DESINTEGRATE)).setParents(LibResearch.KEY_ENCHANTER);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        research = new TTResearchItem(
                ...
                6,
                2,
                new ResourceLocation(LibResources.ENCHANT_QUICK_DRAW)).setParents(LibResearch.KEY_ENCHANTER);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        research = new TTResearchItem(
                ...
                5,
                2,
                new ResourceLocation(LibResources.ENCHANT_VAMPIRISM)).setParents(LibResearch.KEY_ENCHANTER);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        research = new TTResearchItem(
                ...
                new AspectList().add(Aspect.ENTROPY, 3).add(Aspect.ORDER, 3).add(Aspect.WEAPON, 3).add(Aspect.MAGIC, 2),
                0,
                8,
                2,
        ...
        research = new TTResearchItem(
                ...
                new AspectList().add(Aspect.AIR, 3).add(Aspect.ORDER, 3).add(Aspect.ARMOR, 3).add(Aspect.MAGIC, 2),
                7,
                0,
                2,
                new ResourceLocation(LibResources.ENCHANT_POUNCE)).setParents(LibResearch.KEY_ENCHANT_ASCENT_BOOST);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();

        research = new TTResearchItem(
                LibResearch.KEY_ENCHANT_SHATTER,
                new AspectList().add(Aspect.EARTH, 3).add(Aspect.ENTROPY, 3).add(Aspect.TOOL, 1).add(Aspect.MAGIC, 2),
                5,
                8,
                2,
                new ResourceLocation(LibResources.ENCHANT_SHATTER)).setParents(LibResearch.KEY_ENCHANT_DESINTEGRATE);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();

        research = new TTResearchItem(
                LibResearch.KEY_ENCHANT_SHOCKWAVE,
                new AspectList().add(Aspect.AIR, 3).add(Aspect.ENTROPY, 3).add(Aspect.ARMOR, 1).add(Aspect.MAGIC, 2),
                9,
                2,
                2,
                new ResourceLocation(LibResources.ENCHANT_SHOCKWAVE)).setParents(LibResearch.KEY_ENCHANT_SLOW_FALL);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();

        research = new TTResearchItem(
                LibResearch.KEY_ENCHANT_TUNNEL,
                new AspectList().add(Aspect.EARTH, 3).add(Aspect.ORDER, 3).add(Aspect.TOOL, 1).add(Aspect.MAGIC, 2),
                9,
                6,
                2,
                new ResourceLocation(LibResources.ENCHANT_TUNNEL)).setParents(LibResearch.KEY_ENCHANT_AUTO_SMELT);
        research.setPages(new ResearchPage("0")).setSecondary().registerResearchItem();
        ...
        if (Loader.isModLoaded("ComputerCraft")) {
            research = new TTResearchItem(
                    ...
                    0,
                    0,
                    new ItemStack(Items.redstone)).setAutoUnlock().setRound();
    ...
    private static void registerResearchPages() {
        ...
        ResearchCategories.registerCategory(
                ...
                new ResourceLocation(LibResources.MISC_R_ENCHANTING),
                background);
    }
    ...
    public static ResearchPage LeviationaryHelp() {
        return new ResearchPage(
                Arrays.asList(
                        ...
                        Arrays.asList(
                                new ItemStack(
                                        ThaumicTinkerer.registry.getFirstBlockFromClass(BlockMobilizerRelay.class)),
                                new ItemStack(ConfigBlocks.blockHole, 1, 15),
                                new ItemStack(ThaumicTinkerer.registry.getFirstBlockFromClass(BlockMobilizer.class)),
                                new ItemStack(ConfigBlocks.blockHole, 1, 15),
                                new ItemStack(
                                        ThaumicTinkerer.registry.getFirstBlockFromClass(BlockMobilizerRelay.class)))));
    }
