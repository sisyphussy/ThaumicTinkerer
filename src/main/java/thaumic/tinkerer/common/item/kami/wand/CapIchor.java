...
public class CapIchor extends WandCap {
    ...
    public CapIchor() {
        super(
                "ICHOR",
                0.7F,
                new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(ItemKamiResource.class), 1, 4),
                10);
    }
    ...
    public CapIchor(String s) {
        super(
                s,
                0.7F,
                new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(ItemKamiResource.class), 1, 10),
                10);
    }
