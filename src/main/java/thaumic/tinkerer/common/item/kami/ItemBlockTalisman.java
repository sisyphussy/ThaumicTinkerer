...
public class ItemBlockTalisman extends ItemKamiBase implements IBauble {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
        ...
        if (!set) {
            ...
            if (tile != null && tile instanceof IInventory) {
                ...
                int[] slots = inv instanceof ISidedInventory ? ((ISidedInventory) inv).getAccessibleSlotsFromSide(par7)
                ...
                for (int slot : slots) {
                    ...
                    if (stackInSlot == null) {
                        ...
                        if (stack.stackSize != 0) {
                            if (inv.isItemValidForSlot(slot, stack) && (!(inv instanceof ISidedInventory)
                ...
                if (remove > 0) {
                    Item.getItemFromBlock(bBlock).onItemUse(
        ...
        if (block != null && block != Blocks.air) {
            ...
            par3List.add(
                    StatCollector.translateToLocal(
                            new ItemStack(block, 1, getBlockMeta(par1ItemStack)).getUnlocalizedName() + ".name") + " (x"
                            + count
                            + ")");
        }
    ...
    public void onWornTick(ItemStack itemstack, EntityLivingBase entity) {
        ...
        if (!entity.worldObj.isRemote && itemstack.getItemDamage() == 1
                && block != Blocks.air
            ...
            if (highest == -1) {
                ...
                if (hasFreeSlot && (heldItem == null || Item.getItemFromBlock(block) == heldItem.getItem()
    ...
    public IRegisterableResearch getResearchItem() {
        ...
        return (IRegisterableResearch) new KamiResearchItem(
                ...
                17,
                5,
                new ItemStack(this)).setParents(LibResearch.KEY_ICHOR_PICK_GEM, LibResearch.KEY_ICHOR_SHOVEL_GEM)
    ...
    public ThaumicTinkererRecipe getRecipeItem() {
        return new ThaumicTinkererInfusionRecipe(
                ...
                new ItemStack(this),
                9,
                new AspectList().add(Aspect.VOID, 65).add(Aspect.DARKNESS, 32).add(Aspect.MAGIC, 50)
