...
public class ItemKamiResource extends ItemKamiBase {
    ...
    public void getSubItems(Item par1, CreativeTabs par2CreativeTabs, List par3List) {
        for (int i = 0; i < subtypes; i++) par3List.add(new ItemStack(par1, 1, i));
    }
    ...
    public String getUnlocalizedNameInefficiently(ItemStack par1ItemStack) {
        return par1ItemStack.getItemDamage() >= subtypes ? super.getUnlocalizedName(par1ItemStack)
                : "item." + LibItemNames.KAMI_RESOURCE_NAMES[par1ItemStack.getItemDamage()];
    }

    @Override
    public EnumRarity getRarity(ItemStack par1ItemStack) {
        return par1ItemStack.getItemDamage() != 7 && par1ItemStack.getItemDamage() != 6 ? TTCommonProxy.kamiRarity
                : super.getRarity(par1ItemStack);
    }
    ...
    public IRegisterableResearch getResearchItem() {
        ...
        research = (TTResearchItem) new KamiResearchItem(
                ...
                8,
                0,
                new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(ItemKamiResource.class), 1, 7)).setStub()
    ...
    public ThaumicTinkererRecipe getRecipeItem() {
        ...
        return new ThaumicTinkererRecipeMulti(
                new ThaumicTinkererArcaneRecipe(
                        LibResearch.KEY_ICHOR_CLOTH,
                        LibResearch.KEY_ICHOR_CLOTH,
                        new ItemStack(this, 3, 1),
                        new AspectList().add(Aspect.FIRE, 125).add(Aspect.EARTH, 125).add(Aspect.WATER, 125)
                                .add(Aspect.AIR, 125).add(Aspect.ORDER, 125).add(Aspect.ENTROPY, 125),
                        "CCC",
                        "III",
                        "DDD",
                        'C',
                ...
                new ThaumicTinkererArcaneRecipe(
                        ...
                        new AspectList().add(Aspect.FIRE, 100).add(Aspect.EARTH, 100).add(Aspect.WATER, 100)
                                .add(Aspect.AIR, 100).add(Aspect.ORDER, 100).add(Aspect.ENTROPY, 100),
                        " T ",
                        "IDI",
                        " I ",
                        'T',
