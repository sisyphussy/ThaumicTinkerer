...
public class BlockWarpGate extends BlockModContainer {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        for (int i = 0; i < icons.length; i++) icons[i] = IconHelper.forBlock(par1IconRegister, this, i);
    }
    ...
    public ThaumicTinkererRecipe getRecipeItem() {
        ...
        return new ThaumicTinkererInfusionRecipe(
                ...
                new ItemStack(this),
                8,
                new AspectList().add(Aspect.TRAVEL, 64).add(Aspect.ELDRITCH, 50).add(Aspect.FLIGHT, 50),
                ...
                new ItemStack(ThaumicTinkerer.registry.getFirstBlockFromClass(BlockTransvectorDislocator.class)),
