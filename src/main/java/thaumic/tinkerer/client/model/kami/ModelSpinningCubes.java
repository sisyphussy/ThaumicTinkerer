...
public class ModelSpinningCubes extends ModelBase {
    ...
    public void renderSpinningCubes(int cubes, int origRepeat) {
        ...
        for (int r = origRepeat; r >= 0; r--) {
            double ticks = ClientHelper.clientPlayer().ticksExisted - 0.75 * (origRepeat - r);
            ...
            for (int i = 0; i < cubes; i++) {
                ...
                if (r < origRepeat) GL11.glDisable(GL11.GL_BLEND);
